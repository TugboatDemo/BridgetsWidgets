...
/* mercury:section */
class __TwigTemplate_6b4329c0642b5054a616644567c385b3 extends Template
{
...
";
        // line 102
        $context["grid"] = Twig\Extra\Html\HtmlExtension::htmlCva(["grid w-full min-w-0", "gap-4 @sm:gap-6 @3xl:gap-8", "[&>*]:w-full [&>*]:min-w-0", "[&_.view-content]:grid [&_.view-content]:w-full [&_.view-content]:min-w-0", "[&_.view-content]:gap-4 [&_.view-content]:md:gap-6 [&_.view-content]:xl:gap-8"], ["columns" => ["100" => "grid-cols-1", "50-50" => "md:grid-cols-2", "33-33-33" => "md:grid-cols-3", "75-25" => "md:grid-cols-[minmax(0,3fr)_minmax(0,1fr)]", "25-75" => "md:grid-cols-[minmax(0,1fr)_minmax(0,3fr)]", "67-33" => "md:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]", "33-67" => "md:grid-cols-[minmax(0,1fr)_minmax(0,2fr)]", "50-25-25" => "md:grid-cols-[minmax(0,2fr)_minmax(0,1fr)_minmax(0,1fr)]", "25-25-50" => "md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,2fr)]", "25-25-25-25" => "sm:grid-cols-2 lg:grid-cols-4"], "mobileColumns" => ["1" => "", "2" => "grid-cols-2", "3" => "grid-cols-3"], "viewsColumns" => ["100" => "", "50-50" => "[&_.view-content]:md:grid-cols-2", "33-33-33" => "[&_.view-content]:md:grid-cols-3", "25-25-25-25" => "[&_.view-content]:sm:grid-cols-2 [&_.view-content]:lg:grid-cols-4"]], [["columns" => ["25-25-25-25"], "mobileColumns" => ["2"], "class" => "sm:grid-cols-4"]]);
        // line 145
        yield "
";
        // line 146
        $context["grid_classes"] = CoreExtension::getAttribute($this->env, $this->source,         // line 147
($context["grid"] ?? null), "apply", [["columns" => ((        // line 148
array_key_exists("columns", $context)) ? (Twig\Extension\CoreExtension::default(($context["columns"] ?? null), "100")) : ("100")), "mobileColumns" => ((        // line 149
array_key_exists("mobile_columns", $context)) ? (Twig\Extension\CoreExtension::default(($context["mobile_columns"] ?? null), "1")) : ("1")), "viewsColumns" => ((        // line 150
array_key_exists("views_columns", $context)) ? (Twig\Extension\CoreExtension::default(($context["views_columns"] ?? null), "100")) : ("100"))]], "method", false, false, true, 147);
        // line 153
        yield "
<section class=\"";
        // line 154
  ...
  ";
        // line 156
        yield "  ";
        if (( !Twig\Extension\CoreExtension::testEmpty(($context["background_media"] ?? null)) &&  !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, ($context["background_media"] ?? null), "src", [], "any", false, false, true, 156)))) {
            // line 157
            yield "    ";
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["background_media", "margin_block_start", "margin_block_end", "padding_block_start", "padding_block_end", "background_color", "width", "columns", "mobile_columns", "views_columns", "section_header", "section_footer"]);        yield from [];
    }
    ...
    public function block_background_media_block(array $context, array $blocks = []): iterable
    {
        ...
        // line 159
        try {
            $_v0 = $this->load("canvas:image", 159);
        } catch (LoaderError $e) {
            // ignore missing template
            $_v0 = null;
        }
        if ($_v0) {
            yield from $_v0->unwrap()->yield(CoreExtension::toArray(["src" => CoreExtension::getAttribute($this->env, $this->source,             // line 160
($context["background_media"] ?? null), "src", [], "any", false, false, true, 160), "alt" => CoreExtension::getAttribute($this->env, $this->source,             // line 161
($context["background_media"] ?? null), "alt", [], "any", false, false, true, 161), "class" => "object-cover w-full h-full", "width" => CoreExtension::getAttribute($this->env, $this->source,             // line 163
($context["background_media"] ?? null), "width", [], "any", false, false, true, 163), "height" => CoreExtension::getAttribute($this->env, $this->source,             // line 164
($context["background_media"] ?? null), "height", [], "any", false, false, true, 164)]));
        }
        // line 166
        yield "      </div>
    ";
    ...
    {
        return array (  281 => 199,  274 => 198,  268 => 192,  261 => 191,  255 => 180,  248 => 179,  242 => 166,  239 => 164,  238 => 163,  237 => 161,  236 => 160,  228 => 159,  225 => 158,  218 => 157,  209 => 208,  206 => 207,  200 => 204,  197 => 203,  194 => 202,  190 => 201,  187 => 198,  184 => 197,  182 => 196,  178 => 194,  176 => 191,  172 => 190,  169 => 189,  166 => 188,  160 => 185,  157 => 184,  154 => 183,  150 => 182,  147 => 179,  144 => 178,  142 => 177,  138 => 176,  134 => 174,  128 => 172,  125 => 171,  122 => 169,  119 => 168,  116 => 157,  113 => 156,  109 => 154,  106 => 153,  104 => 150,  103 => 149,  102 => 148,  101 => 147,  100 => 146,  97 => 145,  95 => 102,  92 => 101,  90 => 98,  89 => 97,  88 => 96,  87 => 95,  84 => 94,  82 => 76,  79 => 75,  77 => 72,  76 => 71,  75 => 70,  72 => 69,  70 => 66,  69 => 65,  68 => 64,  67 => 63,  66 => 62,  65 => 61,  64 => 60,  61 => 59,  59 => 6,  56 => 5,  54 => 4,  52 => 2,  48 => 1,);
    }
    ...
    {
        static $tags = ["set" => 2, "if" => 156, "block" => 157, "include" => 159];
        static $filters = ["default" => 66, "escape" => 154, "trim" => 183];
