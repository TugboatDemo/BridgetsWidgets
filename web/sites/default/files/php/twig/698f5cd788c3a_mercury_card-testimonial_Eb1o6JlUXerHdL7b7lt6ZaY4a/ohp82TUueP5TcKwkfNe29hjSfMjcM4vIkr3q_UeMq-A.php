...
class __TwigTemplate_55f9e7ed1861bffecfcb6e9d24448c07 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $context["card"] = Twig\Extra\Html\HtmlExtension::htmlCva(["flex h-full flex-col rounded-md p-8"], ["align" => ["center" => "items-center gap-6 text-center", "left" => "items-start gap-4 text-left"], "style" => ["default" => "bg-card", "inverted" => "bg-card-foreground text-card"]]);
        // line 16
        yield "
";
        // line 17
        $context["svg"] = Twig\Extra\Html\HtmlExtension::htmlCva(["absolute"], ["style" => ["default" => "text-card-foreground/10", "inverted" => "text-card/10"]]);
        // line 28
        yield "
";
        // line 29
