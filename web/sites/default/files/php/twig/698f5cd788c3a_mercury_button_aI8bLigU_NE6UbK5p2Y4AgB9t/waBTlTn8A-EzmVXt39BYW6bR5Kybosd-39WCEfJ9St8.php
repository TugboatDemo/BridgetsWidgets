...
/* mercury:button */
class __TwigTemplate_2d34ffeed75104394caaed3896cded15 extends Template
{
...
";
        // line 6
        $context["button_variants"] = Twig\Extra\Html\HtmlExtension::htmlCva(["group flex items-center justify-center transition duration-300 ease-in-out", "rounded-lg leading-tight font-medium", "cursor-pointer no-underline outline-none hover:no-underline", "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]", "disabled:pointer-events-none disabled:opacity-50"], ["size" => ["small" => "gap-1 px-4 py-2 text-sm xl:py-2.5 xl:text-md", "medium" => "gap-2 px-5 py-2 text-md xl:py-3 xl:text-lg", "large" => "gap-3 px-6 py-3 text-lg xl:py-3.5 xl:text-xl"], "variant" => ["primary" => ["bg-primary text-primary-foreground duration-300 ease-in-out hover:bg-primary/85"], "secondary" => ["bg-accent text-accent-foreground duration-300 ease-in-out hover:bg-accent/80"], "primary-inverted" => ["bg-primary-foreground text-primary duration-300 ease-in-out hover:bg-primary-foreground/85"], "secondary-inverted" => ["border border-accent bg-accent-foreground text-accent duration-300 ease-in-out hover:bg-accent-foreground/80"]], "width" => ["full" => "w-full sm:w-fit", "fit" => "w-fit"], "iconPosition" => ["first" => "flex-row", "last" => "flex-row-reverse"]]);
        // line 38
        yield "
";
        // line 39
...
($context["additional_classes"] ?? null)], "method", false, false, true, 64), "html", null, true);
  ...
  >
    ";
        ...
        ";
                // line 78
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(Twig\Extension\CoreExtension::include($this->env, $context, "@mercury/components/icon/icon.twig", ["weight" => "bold", "icon" =>                 // line 83
...
($context["additional_classes"] ?? null)], "method", false, false, true, 96), "html", null, true);
  ...
  >
    ";
        ...
        ";
                // line 110
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(Twig\Extension\CoreExtension::include($this->env, $context, "@mercury/components/icon/icon.twig", ["weight" => "bold", "icon" =>                 // line 115
